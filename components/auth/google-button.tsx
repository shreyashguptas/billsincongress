...
export function GoogleButton({
  ...
  return (
    <Button
      ...
      disabled={busy}
    >
      {/* Google's own "G", in the colours its brand guidelines require. The
          one place a colour literal is allowed in the chrome: it is their
          mark, not ours (Documentation/brand.md, "Adding something new"). */}
