    ...
    >
      <article className="flex flex-col h-full p-5">
        ...
        <div className="flex items-baseline justify-between gap-3 mb-3">
          <span
            className="font-mono text-[11px] uppercase tracking-[0.12em] text-muted-foreground tabular"
...
function formatBillNumber(bill: Bill): string {
  if (bill.bill_type && bill.bill_number) {
    return `${bill.bill_type.toUpperCase()} ${bill.bill_number} · ${formatCongressOrdinal(bill.congress)}`;
  }
