...
| `bills_results_truncated` | A results list was capped by the backend scan limit rather than complete (passive, once per filter set) | `filter_kinds`, `shown`, `known_total`, `variant` | `app/bills/bills-client.tsx` |
