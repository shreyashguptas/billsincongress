...
| `home_topic_selected` | Reader pins a slice of the topic wheel (clicking the slice or its legend row). Unpinning sends nothing | `policy_area`, `is_rest` (the grey "Everything else" slice), `congress` | `components/dashboard/home/topic-wheel.tsx` |
