      ...
      <header className="border-b border-border">
        <div className="container-editorial py-12 sm:py-16">
          ...
          <p className="mt-5 max-w-2xl text-base sm:text-lg text-muted-foreground leading-relaxed">
            Bills.Congress is a public-interest service, free to read. These
          ...
          <div className="lg:col-span-8 space-y-10">
            ...
            <Section number={5} title="Pro subscriptions">
              ...
              <ul className="space-y-2 list-disc pl-5">
                ...
                <li>
                  <strong className="text-foreground">Cancelling.</strong> Cancel
            ...
            <div className="lg:sticky lg:top-24 border-l border-border pl-6 space-y-6">
              <div>
                ...
                <p className="font-serif text-xl font-semibold tracking-tight leading-tight">
                  A public resource, free to read. Use it reasonably.
                </p>
              </div>
