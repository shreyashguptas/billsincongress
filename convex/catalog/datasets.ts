...
export const DATASETS: Record<DatasetName, DatasetDoc> = {
  ...
  stats: {
    ...
    gotchas: [
      ...
      "These are MEASURES, not bills. The total includes simple and concurrent resolutions, which are not bills and can never become law. If the reader asked about bills, say 'measures' or filter `bills` by billType 'hr' and 's'.",
      ...
      "partyLawCounts is measures that became law, a very small number. Do not confuse it with partyCounts. Its values sum to that chamber's law count.",
